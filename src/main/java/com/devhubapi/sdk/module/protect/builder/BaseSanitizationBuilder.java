 ...
 * </p>
 */
public class BaseSanitizationBuilder {

    protected final DataProtectionApi api;
    protected final SanitizationRequest request;

    protected BaseSanitizationBuilder(DataProtectionApi api,
                               String input,
     ...
     */
    public BaseSanitizationBuilder lowercase() {
     ...
     * @return this builder instance for chaining
     */
    public BaseSanitizationBuilder normalizeWhitespace() {
     ...
     * @return this builder instance for chaining
     */
    public BaseSanitizationBuilder removeAccents() {
   ...
   /**
     ...
     * @return this builder instance for chaining
     */
    public BaseSanitizationBuilder removePii() {
     ...
     */
    protected void addOperation(SanitizationRequest.OperationsEnum operation) {
    ...
    /**
     * Applies default values before executing the request ensuring operations list is not null
     */
